# TXO Python Architecture Decision Records v3.1.1

These ADRs define **TXO-specific patterns for Pyhon projects**, reflecting how TentXO operates regardless of framework. For Vert.x-specific patterns, see `adr-foundation-vertx_v1.1.md`.
...
# Current structure
ai/decided/
├── txo-python-adr_v3.2.md          # Current
